#
# Table structure for table 'tx_dnilabspetition_domain_model_petition'
#
CREATE TABLE tx_dnilabspetition_domain_model_petition (
...
CREATE TABLE fe_users (
	...
	synced smallint(5) unsigned DEFAULT '0' NOT NULL,
